    ...
    return(
        <>
            <Flex id='home' h='100vh' flexDir={{ base: 'column', lg: 'row' }} justifyContent='flex-start' alignItems='flex-start'>
                <Flex h='100%' w={{ base: '100%' , lg: '60%', xl: '50%' }} flexDirection='column' justifyContent='center' alignItems={{ base: 'flex-end', lg: 'flex-start' }} p={{ base: 10, '2xl': 20 }}>
                    <motion.div
                    ...
                    >
                        <Heading as='h1' fontSize={{ base: 50, lg: 46, '2xl': 60 }} textTransform='uppercase' maxW='800px' textAlign={{ base: 'right', lg: 'left' }}>
                            {Languages[language]?.home?.title1} <Text display={{ base: 'block', md: 'inline-block' }}>{Languages[language]?.home?.title2}</Text> <Text fontWeight='bold'>Guilherme Caramori</Text>
                        </Heading>
                    </motion.div>
                    <motion.div
                        ...
                        transition={{ duration: 1 }}
                    >
                        <Text fontSize={{ base: 20, sm: 25 }} color='gray.500' textAlign={{ base: 'right', lg: 'left' }} mt={15}>{Languages[language]?.home?.subtitle1} / Freelancer</Text>
                    </motion.div>
                    <motion.div
