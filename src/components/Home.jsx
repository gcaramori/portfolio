    ...
    return(
        <>
            <Flex id='home' h='100vh' flexDir={{ base: 'column', lg: 'row' }} justifyContent='flex-start' alignItems='flex-start'>
                <Flex h='100%' w={{ base: '100%' , lg: '50%' }} flexDirection='column' justifyContent='center' alignItems={{ base: 'center', lg: 'flex-start' }} p={{ base: 10, lg: 20 }}>
                    <motion.div
                        initial={{ opacity: 0, y: -40 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ duration: 1 }}
                    >
                        <Heading as='h1' fontSize={{ base: 50, lg: 60 }} textTransform='uppercase' maxW='800px' textAlign={{ base: 'right', md: 'left' }}>
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 1 }}
                    >
                        <Text fontSize={{ base: 20, sm: 25 }} color='gray.500' textAlign={{ base: 'right', md: 'left' }} mt={15}>Desenvolvedor FullStack / Freelancer</Text>
                    </motion.div>
                    <motion.div
                        ...
                        style={{ width: '100%' }}
                    >
                        <Button as='a' target='_blank' href='https://api.whatsapp.com/send?phone=55199826461199&text=Ol%C3%A1%2C%20tenho%20interesse%20em%20seus%20servi%C3%A7os!' mt={10} p={7} w={{ base: '100%', lg: 'auto' }} boxShadow="md" bg='trasparent' color={buttonFontColor} fontSize={20} border='1px solid' borderColor={buttonBorderColor} borderRadius={0} textTransform='uppercase' _hover={{ bg: buttonBgHoverColor, color: 'white', borderColor: buttonBorderColor }}>Contate-me!</Button>
                    </motion.div>
                </Flex>
                <Flex h='100%' w={{ base: '100%' , lg: '50%' }} justifyContent='center' alignItems='center' p={20} display={{ base: 'none', lg: 'flex   ' }}>
                    <motion.div
